...
class SimulationHandle
{
 ...
 Village,Preference,CombinedVote,Legislature 
	];
	...
	{
		this.s = s;
 sims[0] = new Village(s, Main.calibrationFactor);sims[1] = new Preference(s, Main.calibrationFactor);sims[2] = new CombinedVote(s, Main.calibrationFactor);sims[3] = new Legislature(s, Main.calibrationFactor); 
	}
