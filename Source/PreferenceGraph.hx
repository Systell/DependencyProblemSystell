...
class PreferenceGraph
{
	...
	public var factionPrefRatios:Array<Array<Float>> = [[1, .5, .1], [.5, 1, .1], [.2, .2, .1], [0.01, 0.01, 1]];
	
	public var factionSizeBars:Sprite;
	public var factionSizeBarWidth:Float;
	public var factionSizeRatios:Array<Float> = [.48, .46, .06];
	...
	public var fpa:FindPreferenceAnimation;
	...
	public function new(fpa:FindPreferenceAnimation)
	{
		this.fpa = fpa;
	}
	...
	public function createLabelSprite()
	{
		...
		labelField[4].y = graphY+graphHeight + labelField[4].textHeight;
		labelField[5].text = "Do\nBoth";
	...
	public function calButtonClick(?e:Event)
	{
		...
		resetButton.addEventListener(MouseEvent.CLICK, Preference.reset);
	}
	...
	public function createFactionLegend()
	{
		...
		factionField[1].text = "= Do Both";
		factionField[2].text = "= Do Nothing";
		factionField[3].text = "= Gary";
